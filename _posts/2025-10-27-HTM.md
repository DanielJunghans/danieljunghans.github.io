...
<p align="justify">
Although the proposed capital rules will not fully remove the AOCI opt-out until June 30, 2028, category IV banks have already taken steps in managing price risk using the HTM designation. Category III and IV banks will need to balance liquidity risk from HTM utilization with the risk to capital stemming from unrealized losses on investments. In my opinion HTM balances for category III and IV institutions will shrink as bonds mature and unrealized losses decline. However, I believe HTM balances as a percentage of total investments will likely remain elevated relative to the pre-capital rule proposal levels. Looking forward, banks will need to be more proactive in managing HTM balances to control price risk to capital in changing interest rate environments.  
</p>
